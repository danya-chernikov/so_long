...
# define MAP_DUPLICATES_ERR_MSG		\
	"Error\nThe map must have exactly one exit and one initial player pos\n"
# define MAP_AT_LEAST_1_COL_ERR_MSG	\
	"Error\nMap must contain at least one collectible object\n"
# define MAP_CLTS_NOT_REACH_ERR_MSG	\
	"Error\nMap has some collectibles that are not reachable\n"
# define MAP_NO_WAY_TO_EXIT_ERR_MSG	\
