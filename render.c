...
/*   Updated: 2025/09/21 04:01:24 by dchernik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Determine visible tile range. Expanded visible tile range so we always
 * cover the whole window. Then draw sea everywhere inside that range
 * (this fills margins). Sea tiled even outside map bounds (mlx allows
 * negative coords).
 *     t_point	i; x and y
 *     t_point	p; px and py
 * */
